...
/obj/item/card/emag
	...
	var/microwaved = FALSE // monkestation addition: microwavable emags
	var/microwaved_uses_left = -1 // monkestation addition: microwavable emags
...
// monkestation end: microwavable emags
