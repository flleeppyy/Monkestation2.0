...
/client/verb/verify_in_discord()
	...
	if(cached_one_time_token && cached_one_time_token != "")
		...
		message = "Your one time token is: [one_time_token], Assuming you have the required living minutes in game, you can now verify yourself in discord by using the command <span class='warning'>\" /verifydiscord [one_time_token] \"</span>" // monkestation edit: PLEXORA
