...
export const oocpronouns: Feature<string> = {
  ...
  category: 'CHAT',
  description:
    'Pronouns to show in OOC when someone hovers over your username, Separated by forward slashes. Most common pronouns and neopronouns are accepted. Example: "she/it/fae"',
